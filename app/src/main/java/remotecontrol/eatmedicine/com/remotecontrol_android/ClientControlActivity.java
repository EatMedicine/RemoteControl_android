...
public class ClientControlActivity extends AppCompatActivity {
    ...
    private String[] FuncName = {"结束进程","发送消息","查看电脑文件","执行CMD命令"};
    private int[] CommandIds = {Tools.COMMAND_ID_KILL_PROCESS,Tools.COMMAND_ID_SEND_MESSAGE,Tools.COMMAND_ID_GET_FILE_LIST,Tools.COMMAND_ID_SEND_CMD};
